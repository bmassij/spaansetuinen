      ...
      <div className="relative max-w-2xl w-full bg-gradient-to-br from-white to-emerald-50 rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="relative p-8 md:p-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Kom ons jubileum vieren van 21 t/m 31 maart, dagelijks geopend van 11.00 – 17.00 uur.<br />
            Ontvang een cadeautje bij uw aankoop, doe mee aan onze winacties en word warm ontvangen met<br />
            koffie, thee en iets lekkers!<br />
            Meer info & actievoorwaarden
          </p>
